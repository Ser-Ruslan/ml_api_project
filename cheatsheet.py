...
# =============================================================================
# 2. КЛАСС МОДЕЛИ МАШИННОГО ОБУЧЕНИЯ
# =============================================================================

class LinearRegressionModel:
    """
    Класс имитации модели линейной регрессии.
    """
    ...
    def predict(self, x: np.ndarray) -> float:
        """
        Метод предсказания - принимает массив, возвращает число.
        ...
        # Формула линейной регрессии: y = b0*x0 + b1*x1 + b2*x2
        result = self.b0 * x[0] + self.b1 * x[1] + self.b2 * x[2]
        return float(result)  # Преобразование в float
